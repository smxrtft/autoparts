                ...
                <div class="card-body p-4">
                    <form id="submitForm" action="{{ route('password.update') }}" method="POST" class="reset-form">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="password" class="form-control admin-input @error('password') is-invalid @enderror" id="password" name="password" placeholder="Введите пароль">
                            @error('password')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <input type="password" class="form-control admin-input @error('password_confirmation') is-invalid @enderror" id="password_confirmation" name="password_confirmation" placeholder="Подтвердите пароль">
