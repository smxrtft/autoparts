...
@section('content')
    <div class="container py-4">
        ...
        <div class="alert alert-success position-fixed w-25" role="alert" id="liveToast"
            ...
            <i class="fa fa-check" aria-hidden="true"></i> Успешная регистрация
        </div>
            ...
            <div class="col-md-6 mx-auto">
                <div class="card border-0 shadow-sm admin-card">
                    <div class="card-body p-4">
                        <form id="submitForm" action="{{ route('register') }}" method="POST" class="register-form">
                            @csrf
                            <div class="form-group mb-3">
                                <label for="name" class="form-label">Имя <span class="text-danger">*</span></label>
                                <input type="text" class="form-control admin-input @error('name') is-invalid @enderror"
                                    id="name" name="name" value="{{ old('name') }}" placeholder="Введите имя">
                                @error('name')
