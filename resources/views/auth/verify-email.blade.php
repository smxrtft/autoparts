            ...
            <div class="card border-0 shadow-sm admin-card">
                <div class="card-body p-4">
                    <div class="alert alert-success mb-4">
                        <i class="fas fa-check-circle mr-2"></i> Спасибо за регистрацию! Ссылка для подтверждения отправлена на вашу почту.
                    </div>
            ...
            $('#resendForm').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        form.before('<div class="alert alert-success mb-4"><i class="fas fa-check-circle mr-2"></i>Ссылка для подтверждения отправлена повторно</div>');
                    },
                    error: function(xhr) {
